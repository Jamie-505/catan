...
import de.lmu.settlebattle.catanclient.chipsUI.adapter.RecyclerViewAdapter;
...
public class ItemsFactory implements IItemsFactory<String> {
    ...
    @Override
    public String createRitterkarte(int position) {return "inserted Ritterkarte." + position;}
    @Override
    public String createRitterkarteOffen(int position) {return "inserted offene Ritterkarte." + position;}
    @Override
    public String createSiegpunkt(int position) {return "inserted Siegpunktkarte." + position;}
    @Override
    public String createMonopol(int position) {return "inserted Monopolkarte." + position;}
    @Override
    public String createErfinder(int position) {return "inserted Erfinderkarte." + position;}
    @Override
    public String createStrassenkarte(int position) {return "inserted Strassenkarte." + position;}
